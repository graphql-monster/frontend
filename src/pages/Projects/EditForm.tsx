...
export const ProjectEditForm = ({ onSubmit, storedData, graphQlError, projectId, submitting, submittingDone }: any) => {
  ...
  return (
    <>
      {submitting && <Alert variant={'warning'}>Project is saving...</Alert>}
      {submittingDone && <Alert variant={'success'}>Project is successfuly saved! You can now visit <Link to={`/user/projects/${projectId}/graphiql`} >Admin Playground</Link></Alert>}
