...
# Model Permissions <a name="model-permissions"></a>
...
# @one(role:"admin")  - these are default invisible setting
# @update(role:"admin")  - these are default invisible setting
# @remove(role:"admin") - these are default invisible setting
...
Note: all setting is just addition on the default so admin still keeps all the roles, and can do anything
